...
class MontagnaTemplate:
    def __init__(self, template_name="montagna"):
    ...
    def validate_data(self, data: Dict[str, Any]) -> Tuple[bool, str, Dict[str, Any]]:
        """
        Valida i dati in input secondo il template delle attività montane.
        Verifica sia le attività che l'attrezzatura richiesta.
        ...
        try:
            ...
            # Validazione attività montane
            is_valid, msg, attivita_data = self.validate_attivita_montagna(data)
            if not is_valid:
                return False, msg, corrected_data
            corrected_data.update(attivita_data)

            # Validazione attrezzatura necessaria
            ...
            return True, "Dati delle attività montane validati con successo", corrected_data
